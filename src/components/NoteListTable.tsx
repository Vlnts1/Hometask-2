        ...
        <TBody key={note.id}>
          ...
          <Col>
            <BtnsContainer>
              ...
              {editNoteId === note.id && (
                <EditForm note={note} onClose={handleCloseEditForm} show={editNoteId === note.id} />
              )}
              {!note.archived ? (
                <Button className='edit-btn' data-index='0' onClick={() => handleArchive(note.id)}>
                  <i className='fa-solid fa-box-archive'></i>
                </Button>
              ) : (
                <Button
              ...
              <Button className='remove-btn' data-index='0' onClick={() => handleRemove(note.id)}>
